import { getFlightPrice, deleteBooking, editBooking } from './app.js';
...
export function displayBookings(bookingsToDisplay) {
  ...
  bookingsToDisplay.forEach((booking, index) => {
    ...
    div.innerHTML = `
      ...
      <button onclick="editBooking(${index})">Editar</button>
      <button onclick="deleteBooking(${index})">Eliminar</button>
    `;
